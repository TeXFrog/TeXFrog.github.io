...
title: Source Files
layout: default
parent: "Tutorial: algpseudocodex"
grand_parent: Examples
nav_order: 1
---

# Source Files: algpseudocodex Tutorial

These are the input files for the [algpseudocodex tutorial]({% link examples/tutorial-algpseudocodex/index.md %}).
